...
hugging-success-generic = Вы хлопаете по плечу { $target }.
hugging-success-generic-others = { CAPITALIZE($user) } хлопает по плечу { $target }.
hugging-success-generic-target = { CAPITALIZE($user) } хлопает по плечу вас.
